...
def filefound():
    filepath = u'C:\\Users\\I502317\\pythontest\\题库（单选+多选+判断）.xlsx'
    print(filepath)
    ...
    for count in range(1):
        ...
        while (len(dan_set) < 20):
            ...
            if i not in dan_set:
                ...
                print
                dan_sheet.cell(row=i + 2, column=1).value, dan_sheet.cell(row=i + 2, column=4).value
        ...
        while (len(duo_set) < 10):
            ...
            if i not in duo_set:
                print
                i, duo_sheet.cell(row=i + 2, column=1).value
                duo_set.add(i)
        ...
        while (len(panduan_set) < 10):
            ...
            if i not in panduan_set:
                ...
                print
                dan_sheet.cell(row=i + 2, column=1).value
